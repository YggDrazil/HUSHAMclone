...
addon = xbmcaddon.Addon('plugin.video.freedomiptv')
...
SOURCES = [{"title": "FREEDOM IPTV", "url": "https://dl.dropbox.com/s/2o78d5fojykpqx3/freedomenter.xml", "fanart": "https://dl.dropbox.com/s/n5k5f6z6ysyapfz/IMG_5338.JPG", "GENERO": "IPTV ", "date": "09/12/2016", "credits": "MADDOG", "thumbnail": "https://dl.dropbox.com/s/mgprs9nl6tcurq8/2000px-Fist.svg.png"}]
	...
	try:
		if os.path.exists(favorites) == True:
			...
			if FAV == "[]":
				...
				addDir('[COLOR cyan][B]- FAVOURITES CHANNEL FREEDOM IPTV [/COLOR][/B][/B]','url',4,os.path.join(home, 'resources', 'favourite.png'),FANART,'','','','')
				addDir('','',100,'',FANART,'','','','')
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from FREEDOM IPTV Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(('Add to FREEDOM IPTV Favorites','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from FREEDOM IPTV Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to FREEDOM IPTV Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
