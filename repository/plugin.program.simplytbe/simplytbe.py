...
base='simplytbe'
ADDON=xbmcaddon.Addon(id='plugin.program.simplytbe')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.4"
PATH = "SIMPLY-TB EVER WIZARD"            

    
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/hmemar/husham.com/master/wizard/tbe.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("SIMPLY-TB EVER WIZARD","Downloading ",'', 'Please Wait')
