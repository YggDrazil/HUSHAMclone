...
base='http://www.myandroidshack.tk'
ADDON=xbmcaddon.Addon(id='plugin.video.CubanKing')
...
def CATEGORIES():
    link = OPEN_URL('http://174.56.104.212/CubanWizard/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("CubanKing","Downloading ",'', 'Please Wait')
