...
def CATEGORIES():
	Check_haters()	
	addDir2('Featured HD Movies','https://archive.org/download/hifimoviesdocs/HdMovies.xml',21,icon4,fanartfeature)
	addDir2('HiFi World','https://archive.org/download/hifimoviesdocs/main_page.xml',10,icon3,fanarthifi)
